...
SECRET_KEY = 'django-insecure-v84z6@^x*2c^)*(57w*q8vi!0vl9oj$cje^9e5uvsa-wk2)d*o'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://django-setup-linux-latest.onrender.com",
]
CORS_ALLOW_METHODS = [
    "GET",
    "POST",
...
LOGGING = {
    ...
    'loggers': {
        'django.server': {  # This catches all incoming HTTP requests
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': False,
        },
